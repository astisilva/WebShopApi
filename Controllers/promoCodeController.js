...
promoCodeController = () => {
  ...
  post = async (req, res) => {
    try {
      return await db.modify(req, res, 'AddPromoCode', 'CustomerId', 'Code', 'Value', 'PromoTypeId');
    } catch (err) {
      res.status(500);
      console.log(err);
  ...
  put = async (req, res) => {
    try {
      return await db.modify(req, res, 'UpdatePromoCode', 'CustomerId', 'Code', 'Value', 'PromoTypeId');
    } catch (err) {
      res.status(500);
